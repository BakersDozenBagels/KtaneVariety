...
namespace Variety
{
    ...
    {
        public override string TwitchHelpMessage { get { return "!{0} knob 0 [turn the white knob to that many tickmarks from north]"; } }
        ...
        public override string ToString() { return string.Format("white knob (north is {0})", (NumTicks - Offset) % NumTicks); }
        public override int NumStates { get { return NumTicks; } }
        public override object Flavor { get { return "Knob"; } }
        public override string DescribeSolutionState(int state) { return string.Format("set the white knob to {0}", state, NumTicks, (NumTicks - Offset) % NumTicks); }
        public override string DescribeWhatUserDid() { return "you twisted the white knob"; }
        public override string DescribeWhatUserShouldHaveDone(int desiredState) { return string.Format("you should have set the white knob to {0} (instead of {1})", desiredState, State); }
